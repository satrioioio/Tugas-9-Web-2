...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar col-md-2 p-3 d-none d-md-block">
            ...
            <a href="../mahasiswa/PageMahasiswa.php" class="active-link"><i class="bi bi-people me-2"></i> Data Mahasiswa</a>
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_array($query)) : ?>
                                    <tr>
                                        ...
                                        <td><?= $row[4] ?></td>
                                        <td>
                                            <a href="edit.php?nim=<?= $row['nim'] ?>" class="btn btn-warning btn-sm me-0" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <a href="delete.php?nim=<?= $row['nim'] ?>" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data dosen ini?')">
